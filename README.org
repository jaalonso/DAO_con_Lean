...
+ Enlaces al [[./src/3_Cuantificadores/f_es_creciente_syss_∀xy,x<y→fx≤fy.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/f_es_creciente_syss_∀xy,x<y→fx≤fy.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/3_Cuantificadores/f_es_creciente_syss_∀xy,x<y→fx≤fy.lean" src lean :lines "7-"

*** Una función creciente e involutiva es la identidad
+ Enlaces al [[./src/3_Cuantificadores/Una_funcion_creciente_e_involutiva_es_la_identidad.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Una_funcion_creciente_e_involutiva_es_la_identidad.lean][sesión en Lean Web]] y al vídeo.
...
+ Enlaces al [[./src/3_Cuantificadores/Propiedad:_aIaPb→aI0∨bI1.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Propiedad:_aIaPb→aI0∨bI1.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/3_Cuantificadores/Propiedad:_aIaPb→aI0∨bI1.lean" src lean :lines "7-"

*** Propiedad: ∀ x : ℝ, x^2 = 1 → x = 1 ∨ x = -1
+ Enlaces al [[./src/3_Cuantificadores/Propiedad:_x^2I1→xI1∨xI-1.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Propiedad:_x^2I1→xI1∨xI-1.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/3_Cuantificadores/Propiedad:_x^2I1→xI1∨xI-1.lean" src lean :lines "7-"

*** Propiedad: ∀ x y : ℝ, x^2 = y^2 → x = y ∨ x = -y
+ Enlaces al [[./src/3_Cuantificadores/Propiedad:_x^2Iy^2→xIy∨xI-y.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Propiedad:_x^2Iy^2→xIy∨xI-y.lean][sesión en Lean Web]] y al vídeo.
...
+ Enlaces al [[./src/3_Cuantificadores/Propiedad:_∃k,nIk+1⊢n>0.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Propiedad:_∃k,nIk+1⊢n>0.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/3_Cuantificadores/Propiedad:_∃k,nIk+1⊢n>0.lean" src lean :lines "7-"
...
+ Enlaces al [[./src/3_Cuantificadores/CNS_de_divisible_por_cero.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/CNS_de_divisible_por_cero.lean][sesión en Lean Web]] y al vídeo.
...
+ Enlaces al [[./src/3_Cuantificadores/Principio_de_no_contradiccion.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Principio_de_no_contradiccion.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/3_Cuantificadores/Principio_de_no_contradiccion.lean" src lean :lines "7-"

*** Introducción de la doble negación
+ Enlaces al [[./src/3_Cuantificadores/Introduccion_de_la_doble_negacion.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Introduccion_de_la_doble_negacion.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/3_Cuantificadores/Introduccion_de_la_doble_negacion.lean" src lean :lines "7-"

** Principio del tercio excluso y reducción al absurdo

*** Eliminación de la doble negación
+ Enlaces al [[./src/3_Cuantificadores/Eliminacion_de_la_doble_negacion.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Eliminacion_de_la_doble_negacion.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/3_Cuantificadores/Eliminacion_de_la_doble_negacion.lean" src lean :lines "7-"

*** Demostración por casos: P → R, ¬P → Q, Q → R ⊢ R
+ Enlaces al [[./src/3_Cuantificadores/Demostracion_por_casos.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/3_Cuantificadores/Demostracion_por_casos.lean][sesión en Lean Web]] y al vídeo.
#+INCLUDE: "./src/3_Cuantificadores/Demostracion_por_casos.lean" src lean :lines "7-"
