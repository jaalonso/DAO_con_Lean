...
*** Si |x| ≤ ε, para todo ε > 0, entonces x = 0
+ Enlaces al [[./src/5_Limites/cero_de_abs_mne_todos.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/5_Limites/cero_de_abs_mne_todos.lean][sesión en Lean Web]] y al [[https://youtu.be/YN0F9ldAVCw][vídeo]].
#+INCLUDE: "./src/5_Limites/cero_de_abs_mne_todos.lean" src lean :lines "7-"

*** Si |x - y| ≤ ε, para todo ε > 0, entonces x = y
+ Enlaces al [[./src/5_Limites/ig_de_abs_sub_mne_todos.lean][código]], a la [[https://leanprover-community.github.io/lean-web-editor/#url=https://raw.githubusercontent.com/jaalonso/DAO_con_Lean/master/src/5_Limites/ig_de_abs_sub_mne_todos.lean][sesión en Lean Web]] y al vídeo.
